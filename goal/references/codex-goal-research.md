...
- Gemini CLI custom skills do not expose a reliable live per-turn token usage API to markdown commands. Token budgets are stored and displayed as soft budgets. Time accounting is local and reliable.
